...
public class FormatUtil {
	 ...
	 * @return
	 */
	public static String decimalToStr(Double number, String formatStr) {
	 ...
	 * @return
	 */
	public static Double decimalToStr(String numberStr, String formatStr) {
		DecimalFormat format = new DecimalFormat(formatStr);
		try {
			return format.parse(numberStr).doubleValue();
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return null;
